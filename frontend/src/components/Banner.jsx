...
const Banner = ({ clearChat }) => {
  return (
    <div className='h-[600px] flex flex-col items-center justify-center bg-gradient-to-r from-orange-500 to-orange-600 text-white'>
      <div className='text-center w-[90%] flex flex-col items-between justify-between'>
        ...
        <button 
          onClick={clearChat} 
          className='px-6 py-3 bg-white text-orange-500 font-semibold rounded-lg shadow-md hover:bg-purple-100'>
          Clear Chat
        </button>
