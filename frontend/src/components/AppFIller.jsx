...
const AppFiller = () => {
  return (
    <div className="w-full h-screen moving-gradient">
      ...
      <div className=" flex h-[100%] items-center justify-around p-4 mb-10">
        <div className="w-1/6 h-1/2  rounded-lg shadow-lg bg-[url('https://th.bing.com/th/id/OIP.hhPvSN3HtOWdwwezy5hQPwHaES?w=293&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7')] bg-cover bg-center flex flex-col p-4 transform transition-transform hover:scale-105">
